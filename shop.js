...
(() => {
  ...
  const items = [
    ...
    },
    {
      ...
      price: 1800,
      rarity: "legendary",
      description: "Une bouteille dont la chanson accompagne les pirates depuis des générations. Quand la volonté vacille, quelques notes rappellent pourquoi on a pris la mer.",
      effect: "Améliore les chances d’obtenir une issue favorable lors des deux événements d’Éveil du Haki.",
      hakiAwakeningResolutionBonus: 7,
    },
    {
      id: "den-den-mushi",
      name: "Escargophone",
      ...
      price: 2500,
      rarity: "legendary",
      description: "Un Escargophone réglé sur les fréquences que les grandes puissances utilisent quand quelque chose d’inhabituel secoue les mers.",
      effect: "Augmente les chances de rencontrer un événement légendaire au cours d’une aventure.",
      legendaryChanceMultiplier: 1.35,
    },
  ...
  const profileCosmetics = [
    ...
    { id: "cosmetic-d", type: "name-decoration", name: "D. cosmétique", rarity: "legendary", price: 5600, description: "Ajoute visuellement le D. à la Carte de légende, sans aucun effet en aventure." },
  ].map((item) => Object.freeze(item));

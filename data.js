...
const GAME_DATA = {
  ...
  crewRecruitments: [
    ...
    { id: "jean-bart", name: "Jean Bart", role: "Timonier", icon: "⚓", description: "Protège une traversée en échange d'une route loin des trafiquants.", primaryStat: "health", rarity: "rare", allowedFactions: ["pirate", "bounty-hunter", "revolutionary"], permanentEffects: { health: 4, combat: 1 } },
    { id: "shachi", name: "Shachi", role: "Marin", icon: "🌊", description: "Met sa mobilité au service d'une opération maritime précise.", primaryStat: "intelligence", rarity: "uncommon", allowedFactions: ["pirate", "bounty-hunter"], permanentEffects: { intelligence: 3, health: 1 } },
    { id: "penguin", name: "Penguin", role: "Marin", icon: "🐧", description: "Propose ses relevés de courants contre une place pour la prochaine étape.", primaryStat: "intelligence", rarity: "uncommon", allowedFactions: ["pirate", "bounty-hunter"], permanentEffects: { intelligence: 3, charisma: 1 } },
    ...
    { id: "paulie", name: "Paulie", role: "Charpentier", icon: "🪢", description: "Embarque le temps de remettre un navire et son équipage en état.", primaryStat: "health", rarity: "rare", allowedFactions: ["pirate", "bounty-hunter", "revolutionary"], permanentEffects: { health: 3, intelligence: 2 } },

...
window.BLUE_LEGACY_COMPANION_DIALOGUES = Object.freeze({
  ...
  mansherry: { join: "Je vous accompagne. Tant que nous protégeons les innocents, mes pouvoirs seront à vos côtés.", finalDream: "Je peux soigner les blessures, mais ce dernier pas, c’est à vous de le faire." },
  kureha: { join: "Ne ralentissez pas pour moi, morveux. Je viens surtout vérifier que vous survivrez à vos propres idées.", finalDream: "Tu respires encore, c’est déjà encourageant. Maintenant, montre-moi ce que vaut ton rêve." },
  aladine: { join: "Je prendrai soin des blessés et de la barre. Respectez la mer, et nous nous entendrons.", finalDream: "Le courant devient dangereux. Garde ton cap : il ne reste plus de place pour l’hésitation." },
  bepo: { join: "Je peux vous guider ! Enfin… je ferai de mon mieux. Désolé si j’ai l’air trop enthousiaste !", finalDream: "On y est vraiment ! Ne t’inquiète pas, je surveille la route pendant que tu vas jusqu’au bout." },
  nami: { join: "D’accord, je viens avec vous. Mais pour atteindre la prochaine île en un seul morceau, laissez-moi gérer la navigation.", finalDream: "On y est. Il ne reste plus qu’une route à suivre, alors ne te rate pas maintenant." },
  hatchan: { join: "Je connais ces courants comme mes six poches. Suivez-moi, et on évitera les pires récifs.", finalDream: "La route est libre devant nous. Cette fois, c’est à toi de choisir où elle se termine." },
  cabaji: { join: "Mes acrobaties ne sont pas qu’un numéro de cirque. Je vais vous montrer comment manœuvre un vrai professionnel.", finalDream: "Le grand final approche. Tâche au moins de faire une entrée digne de ce nom." },
  vito: { join: "Très bien, je coordonne l’approche. Respectez le plan, et cette alliance restera profitable.", finalDream: "Toutes les positions sont verrouillées. À toi d’exécuter la dernière phase sans trembler." },
  wadatsumi: { join: "Vous avez protégé les miens, alors Wadatsumi vous protégera ! Personne ne passera par ici !", finalDream: "Wadatsumi gardera vos arrières ! Avancez, et ne vous retournez pas !" },
  kinemon: { join: "Notre alliance sert une cause honorable. Mon sabre accompagnera donc votre route.", finalDream: "L’heure n’est plus aux préparatifs. Avance avec honneur et accomplis ce qui t’a conduit ici." },
  kawamatsu: { join: "Protéger les faibles donne un sens à cette alliance. Mon arme est désormais à votre service.", finalDream: "Nous avons enduré les prisons et les tempêtes. Ce dernier obstacle ne brisera pas ta volonté." },
  killer: { join: "Nos objectifs se croisent. Tant que l’ennemi reste commun, mes lames avanceront avec vous.", finalDream: "Plus de détour possible. Frappe juste, frappe vite, et termine ce que tu as commencé." },
  "daz-bonez": { join: "Le contrat est clair. Je vous accompagne tant que chacun reste concentré sur l’objectif.", finalDream: "Les paroles ne servent plus à rien. Il est temps de prouver que cette route avait un but." },
  bartolomeo: { join: "Une aventure pareille mérite la meilleure barrière du monde ! Comptez sur moi, je ne laisserai rien passer !", finalDream: "C’est le moment légendaire ! Fonce, je protégerai tout ce qui se trouve derrière toi !" },
  cavendish: { join: "J’accepte de vous accompagner. Avec ma présence, cette aventure gagnera enfin l’élégance qu’elle mérite.", finalDream: "N’oublie pas que tous les regards sont tournés vers nous. Offre-leur une conclusion éblouissante." },
  sai: { join: "Une alliance engage la parole de chacun. La mienne est donnée : je combattrai à vos côtés.", finalDream: "Tu as assumé chaque étape de cette route. Assume maintenant la dernière jusqu’au bout." },
  yamato: { join: "Une nouvelle aventure ? Évidemment que je viens ! Allons voir jusqu’où cette route peut nous mener !", finalDream: "C’est donc ici que tout se joue ! Après tout ce chemin, hors de question de s’arrêter maintenant !" },
  "capone-bege": { join: "Cette alliance protège aussi ma famille. Suivez le plan, et personne ne viendra troubler nos affaires.", finalDream: "La cible est devant nous et la sortie est prête. Ne gâche pas l’opération au dernier instant." },
  viola: { join: "Je partagerai ce que mes yeux découvrent. En retour, cette route ne devra pas menacer Dressrosa.", finalDream: "Je vois le danger qui nous attend, mais aussi le chemin parcouru. La décision finale t’appartient." },
  pudding: { join: "Je vous accompagne, mais certaines choses doivent rester secrètes. Ne m’obligez pas à corriger vos souvenirs.", finalDream: "Tous les souvenirs de cette aventure mènent ici. Fais en sorte que le dernier mérite d’être conservé." },
  perona: { join: "Je viens, mais je veux une cabine confortable et aucun endroit sinistre. Enfin… pas trop sinistre.", finalDream: "Même mes fantômes sont nerveux. Termine vite cette histoire avant que l’ambiance devienne vraiment déprimante." },
  "bon-clay": { join: "L’amitié n’abandonne personne en pleine mer ! Je viens avec vous, jusqu’au bout de cette danse !", finalDream: "Le rideau va tomber, mon ami ! Fais de ce dernier pas une scène que personne n’oubliera !" },
  "belo-betty": { join: "Je vous accompagne, mais ne comptez pas sur moi pour agir à la place de ceux qui doivent se lever.", finalDream: "Tu as inspiré assez de monde pour arriver ici. Maintenant, lève-toi et montre-leur pourquoi." },
  ...
  momonga: { join: "Je renforcerai votre ligne. Discipline et sang-froid feront le reste.", finalDream: "La dernière épreuve ne pardonnera aucune hésitation. Tiens ta position et avance." },
  onigumo: { join: "L’ordre est valide. Je prends la ligne d’assaut et j’élimine toute résistance.", finalDream: "L’objectif est à portée. Pas de recul, pas d’excuse : termine la mission." },
  doberman: { join: "J’apporterai l’expérience nécessaire. Que chacun connaisse son rôle avant le départ.", finalDream: "Une grande opération se juge à sa conclusion. Donne à celle-ci une fin digne de nos efforts." },
  dalmatian: { join: "Je rejoins l’unité. Les cibles mobiles ne resteront pas longtemps hors de notre portée.", finalDream: "L’adversaire n’a plus d’espace pour fuir. À toi de fermer définitivement la route." },
  stainless: { join: "Je coordonnerai les bâtiments. Une flotte organisée vaut mieux que cent initiatives isolées.", finalDream: "Toutes les unités sont en place. Le prochain ordre décidera de l’issue entière." },
  yamakaji: { join: "Je stabiliserai le commandement. Dans une crise, une voix claire évite bien des pertes.", finalDream: "La chaîne tient encore après toutes ces tempêtes. Donne-lui maintenant une direction définitive." },
  bastille: { join: "Je tiendrai la ligne. Quoi qu’il arrive, personne ne percera derrière moi.", finalDream: "La défense est solide. Tu peux avancer sans regarder derrière toi." },
  maynard: { join: "Je prends en charge l’infiltration. Moins l’ennemi nous voit, plus l’opération a de chances de réussir.", finalDream: "Notre couverture ne tiendra plus longtemps. C’est le moment d’agir, pas d’observer." },
  "john-giant": { join: "Je protégerai cette unité contre toute flotte assez folle pour l’affronter.", finalDream: "La ligne ne cédera pas tant que je la tiens. Va accomplir ce qui reste à faire." },
  tashigi: { join: "Je vous accompagne. Les lames volées et leurs victimes méritent que cette enquête aille jusqu’au bout.", finalDream: "Nous avons suivi chaque indice jusqu’ici. Maintenant, ne laisse pas la vérité nous échapper." },
  gion: { join: "Je renforcerai cette mission. L’autorité n’a de valeur que si elle sait aussi protéger.", finalDream: "Tu as l’occasion de donner un sens à toute cette route. Ne la laisse pas passer." },
  tokikake: { join: "Les renseignements sont solides, alors je viens. J’espère seulement que le terrain sera moins ennuyeux que le rapport.", finalDream: "Pour une fois, même les rapports avaient raison : tout mène ici. À toi de conclure." },
  hina: { join: "Hina prend en charge les arrestations. Avec des preuves solides, personne ne passera entre les mailles.", finalDream: "Hina n’aime pas les affaires inachevées. Termine celle-ci correctement." },
});

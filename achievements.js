...
(() => {
  ...
  const achievements = [
    ...
    achievement("davy-perfect", "Trois victoires, trois nakamas", "Trois manches et trois tirages ont bouleversé les deux équipages.", "challenges", "mythic", "☠️", "Condition secrète", {type:"davy-perfect"},{secret:true}),
